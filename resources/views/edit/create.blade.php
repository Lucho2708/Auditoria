...
@section('content')
    <div id="page-wrapper">
        ...
        {!! Form::open(['route' => 'edit.users.store', 'method' => 'POST']) !!}
        ...
        <div class="form-group">
            ...
            {!! Form:: select('role',['class'=>'Seleccione tipo de usuario','Editor'=>'Editor','Miembro' => 'Miembro'  ,'Auditor' => 'Auditor'],null, ['class'=>'form-control']) !!}
        </div>
